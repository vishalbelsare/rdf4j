...
public class ParallelMixedReadWrite2Benchmark extends BaseConcurrentBenchmark {
	...
	public static void main(String[] args) throws Exception {
		Options opt = new OptionsBuilder()
				.include("ParallelMixedReadWrite2Benchmark.*") // adapt to run other benchmark tests
				.forks(1)
				.build();
